...
public class UIController : MonoBehaviour
{
  ...
  void ChangeModel()
  {
    if (page_number == 1)
    {
      NavBarController.inst.blackBars[0].SetActive(true);
      NavBarController.inst.blackBars[1].SetActive(false);
      NavBarController.inst.blackBars[2].SetActive(false);
    ...
    {
      NavBarController.inst.blackBars[0].SetActive(false);
      NavBarController.inst.blackBars[1].SetActive(true);
      NavBarController.inst.blackBars[2].SetActive(false);
    ...
    else if (page_number == 3)
    {
      NavBarController.inst.blackBars[0].SetActive(false);
      NavBarController.inst.blackBars[1].SetActive(false);
      NavBarController.inst.blackBars[2].SetActive(true);
